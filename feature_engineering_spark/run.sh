...
$SPARK_HOME/bin/spark-submit \
    ...
    /home/kim/workspace/python/featurestore_demo/feature_engineering_spark/target/scala-2.11/feature_engineering_spark-assembly-0.1.0-SNAPSHOT.jar --input "/home/kim/workspace/python/featurestore_demo/sample_data/kyc.csv"  --partitions 1 --version 1 --cluster --featuregroup "pep_lookup"
